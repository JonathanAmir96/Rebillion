...
The party-quest finale bosses (`docs/WORLD_PLAN.md`; `10_systems/social/PARTY_QUEST.md`) are
ordinary `boss`-tier entities and use the `boss` row above — no separate tier exists.
...
- Hard-CC DR window (10 s) and immunity duration (8 s) are first-pass; may need solo-vs-party-quest
  tuning. Owner: `10_systems/COMBAT_FORMULA.md` / `10_systems/social/PARTY.md`.
