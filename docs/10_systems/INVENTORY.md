...
in any of the six bind towns** (Emberfoot Village `map_001`, Rosen Harbor `map_017`, Millbrook
Central `map_018`, Mossmere `map_043`, Tidewatch Port `map_071`, Cindershelf `map_125` —
`10_systems/DEATH_PENALTY.md` §4, `docs/WORLD_PLAN.md`). The bank mirrors the three tabs:
