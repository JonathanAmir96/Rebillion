...
| Category | Tradeable? |
|---|---|
| Boss unique equipment (`item_equip_0201`–`0216`, `10_systems/ITEMS.md` §11) | **Yes** — no special-case removal; enhancement level and affixes travel with the item (Open Questions). |
